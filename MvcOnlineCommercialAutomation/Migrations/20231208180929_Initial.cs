        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "Varchar(13)", maxLength: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvoiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SerialNo = table.Column<string>(type: "char(1)", maxLength: 1, nullable: false),
                    SequenceNo = table.Column<string>(type: "Varchar(6)", maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesTransactions_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesTransactions_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesTransactions_ClientId",
                table: "SalesTransactions",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTransactions_EmployeeId",
                table: "SalesTransactions",
                column: "EmployeeId");
